...
namespace Amqp
{
    ...
    public class ReceiverLink : Link
    {
        ...
        //chris public void Start(int credit, MessageCallback onMessage = null) 
        public void Start(int credit, MessageCallback onMessage)
        {
            this.onMessage = onMessage;  //chris maybe null 
        ...
        //chris public void SetCredit(int credit, bool autoRestore = true)
        public void SetCredit(int credit, bool autoRestore)
        {
            //chris 
            autoRestore = true; 
        ...
        /// <returns></returns>
        /// 
        //chris public Message Receive(int timeout = 60000) 
        public Message Receive(int timeout)
        {
            //chris return this.ReceiveInternal(null, timeout); 
            return this.ReceiveInternal(null, 60000);
        }
        ...
        //chris public void Reject(Message message, Error error = null)
        public void Reject(Message message, Error error)
        {
            this.ThrowIfDetaching("Reject");
            //this.DisposeMessage(message, new Rejected() { Error = error });
            this.DisposeMessage(message, new Rejected() { Error = null });
        }
        ...
        //chris internal Message ReceiveInternal(MessageCallback callback, int timeout = 60000)
        ...
        sealed class SyncWaiter : Waiter
        {
            ...
            {
                //chris this.signal.WaitOne(timeout);
