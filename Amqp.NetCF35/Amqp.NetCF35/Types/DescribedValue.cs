...
namespace Amqp.Types
{
    ...
    public class DescribedValue : Described
    {
        ...
        {
           //chris  Encoder.WriteObject(buffer, this.descriptor);
            Encoder.WriteObject(buffer, this.descriptor, true);
        }

        internal override void EncodeValue(ByteBuffer buffer)
        {
            //chris Encoder.WriteObject(buffer, this.value);
            Encoder.WriteObject(buffer, this.value, true);
        }
