...
namespace Amqp.Types
{
    ...
    public static class Encoder
    {
        ...
        //chris public static void WriteObject(ByteBuffer buffer, object value, bool smallEncoding = true)
        ...
        public static void WriteMap(ByteBuffer buffer, Map value, bool smallEncoding)
        {
            ...
            else
            {
                ...
                foreach (var key in value.Keys)
                {
                    ...
                    Encoder.WriteObject(buffer, key, true);
                    Encoder.WriteObject(buffer, value[key], true);
                }
